...
class UpcomingMovieDataSourceMain(val compositeDisposable: CompositeDisposable) : PageKeyedDataSource<String,Movie>(){
    ...
    override fun loadInitial(params: LoadInitialParams<String>, callback: LoadInitialCallback<String, Movie>) {
        ...
        compositeDisposable.add(
            ServiceHelper.createService(Endpoint::class.java).getUpcoming(query)
                ...
                .subscribeWith(object : DisposableObserver<WrapperMovie>() {
                    override fun onComplete() {
                        progressLiveStatus.postValue(BaseResponse.success())
                    }

                    override fun onNext(t: WrapperMovie) {
                        callback.onResult(t.results, null, (FIRS_PAGE + 1).toString())
                        TrendingMovieDataSourceMain.PAGE_SIZE = t.total_pages
        ...
        compositeDisposable.add(
            ServiceHelper.createService(Endpoint::class.java).getUpcoming(query)
                ...
                .subscribeWith(object : DisposableObserver<WrapperMovie>() {
                    ...
                    override fun onNext(t: WrapperMovie) {
                        callback.onResult(t.results, (params.key.toInt() + 1).toString())
                    ...
                    override fun onError(e: Throwable) {
                        TrendingMovieDataSourceMain.CURRENT_PAGE -= 1
                        progressLiveStatus.postValue(BaseResponse.error(e))
