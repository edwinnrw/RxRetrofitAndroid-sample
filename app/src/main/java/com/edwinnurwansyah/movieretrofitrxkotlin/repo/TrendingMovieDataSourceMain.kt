...
class TrendingMovieDataSourceMain(private val compositeDisposable: CompositeDisposable) :
    ...
    override fun loadInitial(params: LoadInitialParams<String>, callback: LoadInitialCallback<String, Movie>) {
        ...
        compositeDisposable.add(
            ServiceHelper.createService(Endpoint::class.java).getTrending(query).toObservable()
    ...
    override fun loadAfter(params: LoadParams<String>, callback: LoadCallback<String, Movie>) {
        ...
        query["api_key"] = BuildConfig.API_KEY
        Log.d("TesMovieAfter", "masuk" + params.key)
        compositeDisposable.add(
            ServiceHelper.createService(Endpoint::class.java).getTrending(query)
                ...
                .subscribeWith(object : DisposableObserver<WrapperMovie>() {
                    ...
                    override fun onNext(t: WrapperMovie) {
                        ...
                        CURRENT_PAGE = (params.key + 1).toInt()
