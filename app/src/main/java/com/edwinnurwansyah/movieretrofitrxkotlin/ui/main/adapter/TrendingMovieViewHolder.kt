...
class TrendingMovieViewHolder(val parent: ViewGroup) : RecyclerView.ViewHolder(
    LayoutInflater.from(parent.context).inflate(R.layout.item_trending, parent, false)) {
    private val itemImageMovie = itemView.findViewById<ImageView>(R.id.itemImageTreanding )
    var widht=0
